package com.project;//package model;
...
public class LMSLauncher {
    ...
    public static void main(String args[]) throws InterruptedException, SQLException {
        ...
        System.out.println("----------model.User List-------------");
        for (User u : library.users.getAll())
            System.out.println(u);

        System.out.println("----------model.Book List-------------");
        for (Book b : library.books.getAll())
